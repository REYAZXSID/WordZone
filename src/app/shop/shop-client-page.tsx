...
const powerUps: PowerUp[] = [
  ...
  { id: 'freeze_timer', name: 'Freeze Timer', description: 'Pauses the timer for 30 seconds (in timed modes).', cost: 40, icon: <TimerOff className="h-6 w-6 text-cyan-500" /> },
  { id: 'double_coins', name: 'Double Coins', description: 'Doubles the coin rewards for the next 3 puzzles.', cost: 75, icon: <Gem className="h-6 w-6 text-green-500" /> },
